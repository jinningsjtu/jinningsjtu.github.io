;(function () {
	...
	var pageTransition = function() {
		...
		$("a.transition").click(function(event){
		  	...
		  	$("body").fadeOut(2000, redirectPage);
				// cnt += 1;
				// alert(cnt)
				// storestate[cnt] = linkLocation
				// alert(storestate[cnt])
				// alert(linkLocation);
  ...
  //                   //这里刷新当前url
	// 								  redirectPage("http://love.jinningli.cn.cn/#forward");
  //               }
  //           }, false);
  //       }
  // }
  ...
  //     // var hashName = hashSplit[1];
	// 		redirectPage("http://love.jinningli.cn.cn");
  //     // if (hashName !== '') {
  ...
  // }
	...
	var displaytimediff= function() {
			var initialtime = new Date("September 25,2023 21:00:00");
			var nowtime = new Date();
			// var nowtime = new Date("November 08,2022 11:50:00");
			var date3=nowtime.getTime()-initialtime.getTime();
			...
			document.getElementById("chips-timediff").innerHTML=days+" 天 "+hours+" 小时 "+minutes+" 分钟 "+sec+" 秒 "
	}
	...
	$(function(){
		...
		navigationSection();
		goToTop();
		setInterval(displaytimediff,1000); // refresh time with time
